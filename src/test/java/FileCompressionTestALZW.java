 ...
 * this is the test harness for projects to get an A using LZW Tars
 */
...
public class FileCompressionTestALZW {
    ...
    //LZW normal archive
    @Test
    public void testLZW_normalArchive() throws IOException {
        ...
        File archive = new File(d, "archive.zl");
    ...
    //LZW archived files deleted after compression
    @Test
    public void testLZW_fileDeletedAfterArchive() throws IOException {
    ...
    //LZW normal archive with spaces and endlines
    @Test
    public void testLZW_normalArchiveWithSpacesAndEndl() throws IOException {
    ...
    //LZW empty archive
    @Test
    public void testLZW_emptyArchive() throws IOException {
    ...
    //LZW archive with no files
    @Test
    public void testLZW_archiveWithNoFiles() throws IOException {
